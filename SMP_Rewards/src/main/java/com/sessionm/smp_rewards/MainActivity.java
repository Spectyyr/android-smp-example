...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView _ordersTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _ordersTextView = findViewById(R.id.orders_textview);
        _ordersTextView.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void refreshUI() {
        RewardsFragment f = (RewardsFragment) getSupportFragmentManager().findFragmentById(R.id.rewards_fragment);
        f.onRefresh();
    }
}
