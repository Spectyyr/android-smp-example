...
package com.sessionm.mmc_receipt;
...
public class ReceiptsRecAdapter extends RecyclerView.Adapter<ReceiptsRecAdapter.ReceiptsViewHolder> {

    private final ReceiptsFragment _fragment;
    private final List<Receipt> _receipts;

    public ReceiptsRecAdapter(ReceiptsFragment fragment, List<Receipt> receipts) {
        _fragment = fragment;
        _receipts = receipts;
    }
