...
public class MainActivity extends AppCompatActivity implements SessionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button logOutButton = (Button) findViewById(R.id.mmc_user_logout_btn);
    ...
    IdentityListener _identifyListener = new IdentityListener() {
        ...
        public void onFailure(SessionMError sessionMError) {
            Toast.makeText(MainActivity.this, "Failed! " + sessionMError.getMessage(), Toast.LENGTH_SHORT).show();
        }
    };
